...
2. Run the installer and follow the wizard. It is recommended to choose _Yes_ for the option _"Install missing packages on-the-fly"_ to automate package management.
