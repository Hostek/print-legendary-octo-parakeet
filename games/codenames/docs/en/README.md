...
3.  **Place the Main Board**: Print and place the **Main Board** (Page 1) in the center of the table. 
    *   *Note: The board features duplicate words rotated 180 degrees so players on both sides of the table can read them easily.*
...
On their turn, the Spymaster gives their Field Operatives a clue consisting of exactly **one word** and **one number** (e.g., *"Ocean: 3"*).
